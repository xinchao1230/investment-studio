...
/**
 * GitHub Copilot GPT-5.1-Codex Model Call Test Script
 * Test model ID: gpt-5.1-codex
 */
...
// Model ID
const MODEL_ID = 'gpt-5.1-codex';
const MODEL_NAME = 'GPT-5.1-Codex';

// CAPI endpoint configuration
const CAPI_BASE_URL = 'api.githubcopilot.com';
const RESPONSES_ENDPOINT = '/responses';  // ✅ GPT-5.1-Codex uses the /responses endpoint
