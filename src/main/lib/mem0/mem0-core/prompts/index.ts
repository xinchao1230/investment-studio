...
export function removeCodeBlocks(text: string | any): string {
  // 🔥 Fix: handle non-string input
  if (typeof text !== 'string') {
    
    // 🔥 Key fix: if it's an LLM response object (containing content field), extract content
