...
export interface ContentPart {
  type: 'text' | 'image' | 'file' | 'office' | 'others' | 'thinking';
}
...
// Thinking content part (single message during model reasoning)
// In Agent mode, assistant messages without <FINAL_SUMMARY> tag are aggregated into the thinking section
export interface ThinkingContentPart extends ContentPart {
  type: 'thinking';
  text: string; // Original text content (message content without <FINAL_SUMMARY> tag)
