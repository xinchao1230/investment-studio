---
name: audit-xls
description: "Audit a spreadsheet for formula accuracy, errors, and common mistakes. Triggers on: audit this sheet, check my formulas, find formula errors, QA spreadsheet, debug model, model check, model won't balance, 审计模型, 检查公式, 模型检查"
---
