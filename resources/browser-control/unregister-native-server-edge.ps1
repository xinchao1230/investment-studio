# Native Server Unregistration Script for Edge
...
Write-Host "Unregistering Native Messaging Host for Edge..." -ForegroundColor Cyan
...
$RegSubkeyPath = "HKCU:\Software\Microsoft\Edge\NativeMessagingHosts\$HostName"
try {
